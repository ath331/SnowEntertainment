...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='C:/Users/ath33/OneDrive/Desktop/a/C++/Inflearn/C++ServerAndUnRealClient/Part4/Server/GameServer/GameDB.xml', help='Xml Path')
